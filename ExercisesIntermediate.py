...
#Exercise 13: Write a function that takes a word and returns how many consonants it has
...
#Exercise 14: Create a dictionary with 3 students and scores. Add a new student. Print the dictionary.

"""students = {"student1":19, "student2":12, "student3":15}
students["student4"] = "16"
print(students)"""

#Exercise 15:  Import the datetime module. Print the current year
...
#Exercise 17:  Create a dictionary with 4 countries and capitals. Print the country with capital“Paris”.

"""countries = {"France": "Paris", "Germany": "Berlin", "Italy": "Rome", "Spain": "Madrid"}
for key, value in countries.items():
    if value == "Paris":
        print(key)"""
#Exercise 17:  Import the time module. Pause the program for 2 seconds
...
#Exercise 17: Write a function that takes a word and returns it with the last letter capitalized
...
#Exercise 12: Write a function that takes a number and returns its square root using the math module
...
#Exercise 13: Create a set with 5 numbers. Find the difference with another set of 3 numbers
...
#Exercise 16: Write a function that takes a list and returns it sorted in descending order
